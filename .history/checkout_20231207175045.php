...
<form action="payment.php" method="post">
   ...
   <div class="user-info">
      ...
      <!-- <form action="payment.php" method="post">
         <button class="btn" type="submit" name="redirect">Payment via VNPay</button>
      </form> -->
      <input type="submit" value="place order" class="btn <?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="redirect">
   </div>
